...
<head>
    ...
    <title>Actualizar Rivalidad</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-4">
    <h1 class="text-center">Actualizar una Rivalidad</h1>

    <form method="POST" action="/rivalidades/modificar" class="mt-4">
        <div class="mb-3">
            <label for="idorganizacion" class="form-label">ID de la Organizacion</label>
            <input type="text" name="idorganizacion" id="idorganizacion" maxlength="3" class="form-control" required>
        </div>
        <div class="mb-3">
